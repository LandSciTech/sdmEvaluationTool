...
to make a similar selection. These settings will apply to
the materials being shown in the other tabs with respect to
deployments, models, and species. Come back here any time or use the
top navigation to make changes to these values.

![](./images/tabs-01.png)

Once a deployment is selected, you'll see a welcome message on the right.
Hide this message by clicking the arrow in the top right corner.
