...
[sdm_evaluation_results.zip](https://drive.google.com/file/d/12dZ8vpiNuusICc4b1QyREr1NI8HQAM1t/view?usp=drive_link) to your *sdmEvaluationTool* project folder. If you have an older version of
...
opens the glossary. Search for words in the glossary by typing into the Search area.
...
Select the base layer, turn on the Distribution or Uncertainty layers.
...
and Presences, and also the Subunits.
