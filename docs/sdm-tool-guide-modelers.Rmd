...
First, download the [example model materials](https://drive.google.com/file/d/1CJZ_TDy5XPF3UtyDz6IrWzuShyO1bdxx/view?usp=drive_link) to your sdmEvaluationTool project folder. 

Then follow the [`data-loading-example_JH.R`](data-loading-example_JH.R) script.

We first load libraries, unzip demo materials, remove old prepared materials, and set up variables:
...
After confirming the deployment works, compress the deployment materials and the fresh database:
